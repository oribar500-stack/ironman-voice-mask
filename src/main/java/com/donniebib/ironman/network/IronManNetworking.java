...
public final class IronManNetworking {
    public static void initialize() {
        PayloadTypeRegistry.serverboundPlay().register(MaskCommandPayload.TYPE, MaskCommandPayload.CODEC);
        PayloadTypeRegistry.clientboundPlay().register(HelmetStatePayload.TYPE, HelmetStatePayload.CODEC);
